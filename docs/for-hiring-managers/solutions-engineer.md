# Praxis for Solutions Engineer

## What this role needs to prove

Solutions Engineer candidates need to show they can connect messy customer operations to a working technical proof, explain the risk boundary, and translate the result into value.

## How Praxis proves it

Praxis demonstrates solution pack, FieldLab run, proof object, executive value case.
