# Praxis for Customer Engineer

## What this role needs to prove

Customer Engineer candidates need to show they can connect messy customer operations to a working technical proof, explain the risk boundary, and translate the result into value.

## How Praxis proves it

Praxis demonstrates customer context, ontology mapping, missing-field questions, proof artifact.
