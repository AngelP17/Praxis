# Praxis for Technical Solutions Consultant

## What this role needs to prove

Technical Solutions Consultant candidates need to show they can connect messy customer operations to a working technical proof, explain the risk boundary, and translate the result into value.

## How Praxis proves it

Praxis demonstrates value case, expansion map, executive readout.
