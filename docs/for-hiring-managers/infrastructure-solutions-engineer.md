# Praxis for Infrastructure Solutions Engineer

## What this role needs to prove

Infrastructure Solutions Engineer candidates need to show they can connect messy customer operations to a working technical proof, explain the risk boundary, and translate the result into value.

## How Praxis proves it

Praxis demonstrates S3/SQS/DynamoDB/EventBridge topology and runtime state.
