      ...
      <div className="sentinel-v2-panel-strong rounded-[1.4rem] p-6">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <div className="h-2 w-56 animate-pulse rounded-md bg-zinc-800/60" />
          </div>
          <div className="h-10 w-10 animate-pulse rounded-xl border border-zinc-700/70 bg-zinc-900/80" />
        </div>
        <div className="mt-6 h-2 animate-pulse rounded-md bg-zinc-800/55" />
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="sentinel-v2-panel rounded-[1.15rem] p-5">
            ...
            <div className="mt-4 h-8 w-16 animate-pulse rounded-md bg-zinc-800/90" />
