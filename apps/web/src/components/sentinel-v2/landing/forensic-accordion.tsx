  ...
  return (
    <section className="flex h-full w-full gap-1 overflow-hidden rounded-xl py-20">
      {items.map((item) => (
        <article
          key={item.id}
          className="group relative flex flex-1 flex-col justify-between overflow-hidden rounded-lg bg-zinc-950/60 px-3.5 py-3.5 transition-all duration-500 ease-out hover:flex-[2.5] hover:bg-zinc-800/60"
        >
