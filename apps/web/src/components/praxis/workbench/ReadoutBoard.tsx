...
export function ReadoutBoard({ packId: propPackId, runId }: { packId?: string; runId?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <article className="relative w-full max-w-[780px] overflow-hidden border border-[var(--praxis-line)] bg-[var(--praxis-surface)] p-11" style={{ boxShadow: "0 30px 80px rgba(0,0,0,0.45)" }}>
