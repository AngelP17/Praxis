...
export function LoadingState() {
  return (
    <div className="mt-6 grid gap-4">
      <div className="grid grid-flow-dense gap-4 md:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="legacy-card rounded-[24px] border border-zinc-800/60 bg-black/20 p-5 hover:scale-105 transition-transform duration-500">
      ...
      <div className="legacy-card rounded-[26px] p-6 hover:scale-105 transition-transform duration-500">
