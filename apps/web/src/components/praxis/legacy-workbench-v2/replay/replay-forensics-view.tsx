...
import { MotionReplayRail } from "@/components/praxis/legacy-workbench-v2/motion/motion-replay-rail";
...
export function ReplayForensicsView({
  ...
  return (
    <main className="praxis-v2-root min-h-[100dvh] overflow-x-hidden px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1580px]">
        <section className="praxis-v2-panel-strong p-5 sm:p-6 py-20">
          <div className="grid grid-flow-dense gap-4 xl:grid-cols-[1.2fr,0.8fr]">
            <div>
              <div className="praxis-v2-eyebrow">Replay Forensics</div>
            ...
            <div className="rounded-xl border border-zinc-700/70 bg-zinc-950/75 p-3.5">
              <div className="praxis-v2-eyebrow">Replay Path</div>
              <div className="mt-2">
                <MotionReplayRail
                  nodes={[
        ...
        <section className="mt-4 grid grid-flow-dense grid-cols-12 gap-4 py-20">
          <div className="col-span-12 xl:col-span-5">
            <div className="praxis-v2-panel h-full p-4">
              <div className="praxis-v2-eyebrow">Decision History</div>
          ...
          <div className="col-span-12 xl:col-span-7">
            <div className="praxis-v2-panel h-full p-4">
              <div className="praxis-v2-eyebrow">Event Timeline</div>
        ...
        <section className="mt-4 grid grid-flow-dense grid-cols-1 gap-4 xl:grid-cols-3 py-20">
          <div className="praxis-v2-panel p-4">
            <div className="praxis-v2-eyebrow">Evidence Chain</div>
          ...
          <div className="praxis-v2-panel p-4">
            <div className="praxis-v2-eyebrow">Audit Bundle</div>
            <div className="mt-3 space-y-2">
          ...
          <div className="praxis-v2-panel p-4">
            <div className="praxis-v2-eyebrow">Operator Feedback Checkpoint</div>
            <div className="mt-3 space-y-2">
